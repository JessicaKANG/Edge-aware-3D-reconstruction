...
int main(int argc, char **argv)
{
  ...
  std::cout << std::endl
    ...
    << " ICCV 2013.\n" 
    << "Modifed by Jessica Kang 2018 07 MAY"<< std::endl
    << "------------------------------------------------------------"
    << std::endl;
...
//     
  ...
  // for debugging
  sSfM_Data_Filename = "/home/jessica/jessica/SfM_quality_evaluation-master/EvaluationOutput/evaluation_output/Herz-Jesus-P8/matching/sfm_data.json";
  sMatchesDir = "/home/jessica/jessica/SfM_quality_evaluation-master/EvaluationOutput/evaluation_output/Herz-Jesus-P8/matching";
  sOutDir = "/home/jessica/jessica/OpenEDGE/tmp_output";
